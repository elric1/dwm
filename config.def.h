...
/* layout(s) */
static const float mfact     = 0.25; /* factor of master size [0.05..0.95] */
...
static Key keys[] = {
	...
	{ MODKEY,               XK_p,      spawn,          {.v = dmenu_vms}},
	{ MODKEY|ShiftMask,     XK_p,      spawn,          {.v = dmenu_dom0}},
	...
	{ MODKEY,               XK_q,      quit,           {.ui=1} },
	{ MODKEY|ShiftMask,     XK_q,      quit,           {.ui=0} },
};
